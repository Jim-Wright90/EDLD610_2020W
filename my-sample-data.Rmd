...
#Jim: Hey Claire, I'm having an error running the last code function in this chunk. The error keeps telling me that I can't recode the the object because it is an object of class. 
```
...
#Jim: Similar to the chunk above, I'm having trouble running this code because of an error in the recode function. I'm not positive what's causing it. It may be a good idea to talk to Daniel about it. 
```
...
#Jim: I'm unable to get this code chunk to run. I think it might be a problem within the mutate portion of the code chunk.
```
...
Jim Feedback: 
Hey Claire I think you're off to a great start! I had some trouble running a few code chunks in the my-sample-data rmd file, but I'd be happy to chat with you in class about it. And if it's running on your end then disregard. I really like the plot in the ceps-data-inspection rmd file. I left a few suggestions about some changes you can make, but overall I think it looks great and you've done such a great job so far!
