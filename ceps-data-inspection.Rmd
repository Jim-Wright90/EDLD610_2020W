...
#Jim: Really nice job on this plot, Claire! I think the use of geom_text and OkabeIto is really helpful. One suggestion I have is to incorporate coord_flip() the way Daniel tends to do in class. That may make comparison of the bars easier. I wonder if you could also facet_wrap by the wave numbers? Just some suggestions! 
```
